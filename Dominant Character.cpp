...
void solve() {
    ...
    elif(s.find("aba")!=string::npos) cout<<3;
    elif(s.find("aca")!=string::npos) cout<<3;
    elif(s.find("abca")!=string::npos) cout<<4;
    elif(s.find("acba")!=string::npos) cout<<4;
    elif(s.find("abbacca")!=string::npos) cout<<7;
    elif(s.find("accabba")!=string::npos) cout<<7;
    else cout<<-1;
    nl
}
